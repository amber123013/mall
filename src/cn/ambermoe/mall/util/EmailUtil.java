...
public class EmailUtil {
    ...
    public static void sendPassword(String password, String email) throws MessagingException {
        // 创建Properties 类用于记录邮箱的一些属性
           Properties props = new Properties();
           // 表示SMTP发送邮件，必须进行身份验证
           props.put("mail.smtp.auth", "true");
           ...
           props.put("mail.user", "1193756987@qq.com");
           // 此处的密码就是前面说的16位STMP口令
           props.put("mail.password", "rlqywxyjppmpgaid");
           ...
           // 设置邮件的内容体
           message.setContent("请记住此密码！ 密码: " + password, "text/html;charset=UTF-8");
