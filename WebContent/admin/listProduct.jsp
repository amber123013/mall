...
<div class="workingArea">
    ...
    <ol class="breadcrumb">
      ...
      <input style="margin-left:5%;padding: 3px 8px;" id="addProduct" type="button" class="btn btn-success" value="新增产品">
    </ol>
    ...
    <div class="modal" id="addProductModal" tabindex="-1" role="dialog" style="margin-top:10%">
