...
<div  id="carousel-of-product"  class="carousel-of-product carousel slide1" data-ride="carousel">
  ...
  <div class="carousel-inner" role="listbox">
    <div class="item active">
      <img class="carousel carouselImage" src="img/lunbo/ad1.jpg" >
    </div>
    <div class="item">
      <img  class="carouselImage" src="img/lunbo/ad2.jpg" >
    </div>
    <div class="item">
        <img  class="carouselImage" src="img/lunbo/ad3.jpg" >
    </div>
    <div class="item">
        <img  class="carouselImage" src="img/lunbo/ad4.jpg" >
    </div>
  </div>
